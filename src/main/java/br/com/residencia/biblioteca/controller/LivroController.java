...
public class LivroController {
	...
	@PostMapping("/dto")
	public ResponseEntity<LivrosDTO> saveLivrosDTO(@RequestBody LivrosDTO livroDTO) {
		return new ResponseEntity<>(livroService.saveLivrosDTO(livroDTO),
				HttpStatus.CREATED);
	}
	...
	@PutMapping("/dto/{id}")
	public ResponseEntity<LivrosDTO> updateLivroDTO(@RequestBody LivrosDTO livroDTO, 
			@PathVariable Integer id){
